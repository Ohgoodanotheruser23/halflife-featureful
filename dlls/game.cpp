...
cvar_t smartfriendlyfire	= { "mp_smartfriendlyfire","1", FCVAR_SERVER };
...
cvar_t pickup_policy = { "pickup_policy","1", FCVAR_SERVER };
...
// REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	REGISTER_SKILL_CVARS(sk_panic_delay_factor);
