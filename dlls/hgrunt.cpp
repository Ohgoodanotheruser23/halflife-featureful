...
public:
	...
	void DropMyItem(char *entityName, const Vector &vecGunPos, const Vector &vecGunAngles, BOOL isGibbed);
...
void CHGrunt::DropMyItem(char* entityName, const Vector& vecGunPos, const Vector& vecGunAngles, BOOL isGibbed)
{
