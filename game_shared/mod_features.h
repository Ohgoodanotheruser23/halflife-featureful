...
#define FEATURE_OPFOR_WEAPONS 0
#define FEATURE_OPFOR_MONSTERS 0
#define FEATURE_BSHIFT_MONSTERS 0
#define FEATURE_SVENCOOP_MONSTERS 1

// New monsters
#define FEATURE_ZOMBIE_BARNEY (1 || FEATURE_OPFOR_MONSTERS)
#define FEATURE_ZOMBIE_SOLDIER (1 || FEATURE_OPFOR_MONSTERS)
#define FEATURE_GONOME (1 || FEATURE_OPFOR_MONSTERS)
#define FEATURE_PITDRONE (1 || FEATURE_OPFOR_MONSTERS)
#define FEATURE_SHOCKTROOPER (1 || FEATURE_OPFOR_MONSTERS)
#define FEATURE_VOLTIFORE (1 || FEATURE_OPFOR_MONSTERS)
#define FEATURE_MASSN (1 || FEATURE_OPFOR_MONSTERS)
#define FEATURE_BLACK_OSPREY (1 || FEATURE_OPFOR_MONSTERS)
#define FEATURE_BLACK_APACHE (1 || FEATURE_OPFOR_MONSTERS)
#define FEATURE_OTIS (1 || FEATURE_OPFOR_MONSTERS)
#define FEATURE_CLEANSUIT_SCIENTIST (1 || FEATURE_OPFOR_MONSTERS)
...
#define FEATURE_GRAPPLE (1 || FEATURE_OPFOR_WEAPONS)
#define FEATURE_DESERT_EAGLE (1 || FEATURE_OPFOR_WEAPONS)
#define FEATURE_PENGUIN (0 || FEATURE_OPFOR_WEAPONS)
#define FEATURE_M249 (0 || FEATURE_OPFOR_WEAPONS)
#define FEATURE_SNIPERRIFLE (1 || FEATURE_OPFOR_WEAPONS)
#define FEATURE_DISPLACER (0 || FEATURE_OPFOR_WEAPONS)
#define FEATURE_SHOCKRIFLE (1 || FEATURE_OPFOR_WEAPONS)
