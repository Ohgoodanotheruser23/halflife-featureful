...
#define FEATURE_OPFOR_GRUNT 0

#define FEATURE_ISLAVE_DEAD 0
#define FEATURE_HOUNDEYE_DEAD 0
#define FEATURE_OPFOR_DEADHAZ 0
#define FEATURE_SKELETON 0
...
#define FEATURE_KNIFE 0
#define FEATURE_GRAPPLE 0
#define FEATURE_DESERT_EAGLE 1
#define FEATURE_PENGUIN 0
#define FEATURE_M249 0
#define FEATURE_SNIPERRIFLE 1
#define FEATURE_DISPLACER 0
